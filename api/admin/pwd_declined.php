  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>PERSON WITH DISABILITY OVERVIEW</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">PERSON WITH DISABILITY LIST OF DECLINED</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tbody>
                  <?php
                    $query = "SELECT * FROM pwd_db WHERE status='Declined' ORDER BY pwd_id DESC";
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a data-toggle="modal" class="btn btn-sm btn-a edit" title="View More Info" href="#pwd_view_more_info<?php echo $id; ?>" href="#pwd_view_more_info"><i class="fa fa-eye"></i></a>
                        &nbsp;
                        <a data-toggle="modal" class="btn btn-a btn-sm" title="Update Status" href="#pwd_edit<?php echo $id; ?>" name="selector" value="<?php echo $id; ?>"><i class="fa fa-edit"></i></a>
                      </td>
                      <?php include("modals/pwd_view_profile.php"); ?>
                      <?php include("modals/pwd_view_file.php"); ?>
                      <?php include("modals/pwd_update_modal.php"); ?>
                      <?php include("modals/pwd_view_modal.php"); ?>
                    </tr>
                    <?php
                      $counter++;
                    } ?>
