...
<!-- ./modal -->
<div id="pwd_view_more_info<?php echo $id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <div class="input-group input-group">
                      <label class="col-sm-4">Disability:</label>
                      <input class="form-control col-sm-8" type="text" value = " <?php echo $disability; ?>" disabled>
                    </div>
                  </div>
